@echo off
chcp 65001 >nul
title Mahjong Soul Coach - review + dark tiles
cd /d "%~dp0"
...
echo ============================================
echo   Mode: REVIEW + DARK TILES
echo   (advice after you discard, tiles hidden
echo   by default, hold a tile to peek)
...
>> "%TEMP%\cjc_start.vbs" echo sh.Run "cmd /c node live\live_coach.js --review --dark-tiles >> server.log 2>&1", 0, False
