@echo off
chcp 65001 >nul
title Mahjong Soul Coach - review mode
cd /d "%~dp0"
...
echo ============================================
echo   Mode: REVIEW (advice after you discard)
...
>> "%TEMP%\cjc_start.vbs" echo sh.Run "cmd /c node live\live_coach.js --review >> server.log 2>&1", 0, False
